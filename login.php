...
<html >
    ...
    <body>
        <div class="wrap">
            ...
            <form method="post" id="theForm" action="authchallenge.php">
                <input type='text' id="username" name='adminusername' placeholder='Username'>
                <input type='password' id='password' name='adminpassword' placeholder='Password'>
                <div class='login'>
                    <input type='submit' value='Login' name="btnAdminLogin">
